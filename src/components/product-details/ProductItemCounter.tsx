...
const ProductItemCounter = () => {
  ...
  return (
    <div className='product__count'>
        <IconButton ariaText='Decrease Item Count By 1' handleClick={decreaseCount} className="counter__btn">
        ...
        <IconButton ariaText='Increase Item Count By 1' handleClick={increaseCount} className="counter__btn">
